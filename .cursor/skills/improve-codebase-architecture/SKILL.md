...
Use the `Subagent` tool with `subagent_type="explore"` to navigate the codebase naturally. Do NOT follow rigid heuristics - explore organically and note where you experience friction:
